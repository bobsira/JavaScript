...
var x =2, y = 3;         // These = signs are assignement, to equality tests
x == y                   // => false: equality
x != y                   // => true: inequality
x < y                    // => true: less-than
...
!(x==y)                  // =>true: ! invert a boolean value
...
// We can define our own methods,too.The "this" keyword refers to the object on
// which the method is defined: in this case, the points array from above.
points.dist = function () {      // Define a method to compute distance between points
  ...
  return Math.sqrt(a*a+ b*b);    // The Pythagorean theorem. The Math.sqrt() computes the square root
};
points.dist();                   // => 1.414: distance between out 2 points
...
function factorial(n) {             // A function to compute factorial
...
// Define a construcor function to initialize a new Point object
function Point(x,y){                //By convention, construcor start with capitals
  this.x = x;                       //this keyword is the new object being initialized
  this.y = y;                       //Store function arguments as object properties
}                                   //No return is necessary

// Use a construcor function with the keyword "new" to create instances
var p = new Point(1,1);             //The geometric point(1,1)

//Define methods for Point objects by assigning them to the prototype
//object associated with the construcor function.
